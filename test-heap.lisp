;;;
;;; $Header: /home/gene/library/website/docsrc/lisp-heap/RCS/test.lisp,v 395.1 2008/04/20 17:25:55 gene Exp $
;;;
...
(defun comp (a b) (< (car a) (car b)))
(defmacro make-el (n h)
  `(,n (life-of-number ,n h))
  )

(defun life-of-number (n h)
  (let ((k (* 2 n)))
    (heap-insert h (make-el k h)) 
;    (heap-insert h `(,(1+ k) `(life-of-number ,(1+ k) h) )) 
  ) 
  (print n))
